...
class TestUrjanetAustinTXTransformer(test_util.UrjaFixtureText):
    ...
    def test_austin_tx_water(self):
        ...
        """
        self.austin_tx_fixture_test("input_4183840241_227386.json",
                                    "expected_4183840241_227386.json")
        self.austin_tx_fixture_test("input_4183840241_234114.json",
                                    "expected_4183840241_234114.json")

    def test_austin_tx_water_and_electric(self):
        """Tests on account with both water and electric charges."""
        self.austin_tx_fixture_test("input_2901591427_9999590.json",
                                    "expected_2901591427_9999590.json")
        self.austin_tx_fixture_test("input_2901591427_213758.json",
                                    "expected_2901591427_213758.json")

    def test_austin_tx_other(self):
        """Test other oddities with Austin bills."""
        # electric meter with late fee
        self.austin_tx_fixture_test("input_0375958587_4000187.json",
                                    "expected_0375958587_4000187.json")
        # multiple submeters
        self.austin_tx_fixture_test("input_8166749309_6106597,2003604.json",
                                    "expected_8166749309_6106597,2003604.json")
        self.austin_tx_fixture_test("input_8166749309_6104572.json",
                                    "expected_8166749309_6104572.json")
