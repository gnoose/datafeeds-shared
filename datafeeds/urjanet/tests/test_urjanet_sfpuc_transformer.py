...
class TestUrjanetSfpucWaterTransformer(test_util.UrjaFixtureText):
    def sfpuc_fixture_test(self, input_name, expected_name, start_date=None, end_date=None):
        self.fixture_test(
