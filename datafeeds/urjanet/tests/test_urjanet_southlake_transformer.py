...
class TestUrjanetSouthlakeTransformer(test_util.UrjaFixtureText):
    def southlake_fixture_test(self, input_name, expected_name, start_date=None, end_date=None):
        self.fixture_test(
    ...
    def test_florence_elem_fixture(self):
        ...
        self.southlake_fixture_test("florence_elem_input.json", "florence_elem_expected.json")
