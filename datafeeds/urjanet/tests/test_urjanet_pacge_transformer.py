...
class TestUrjanetPacGeTransformer(test_util.UrjaFixtureText):
    def pacge_fixture_test(self, input_name, expected_name, start_date=None, end_date=None):
        self.fixture_test(
    ...
    def test_simple_fixture(self):
        ...
        self.pacge_fixture_test(
            "simple_fixture_input.json",
            "simple_fixture_expected.json")
    ...
    def test_simple_mutli_statement_fixture(self):
        ...
        self.pacge_fixture_test(
            "multi_source_link_input.json",
            "multi_source_link_expected.json")
